...
import { Table, Navbar, Container, Form, FormControl, Nav } from 'react-bootstrap';
...
function AdminPage() {
  ...
  return (
    <div>
      <Layout>
        <Header style={{backgroundColor:"#0000000A"}} >
              ...
              <Navbar bg="light" expand="lg">
                <Container fluid>
                  ...
                  <Navbar.Collapse id="navbarScroll">
                    ...
                    <Nav.Link href="#action1" style={{color:'#FAA81D',fontWeight:"bold"}} >Batch List</Nav.Link>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                        ...
                        <td style={{ color: "#FAA81D", marginLeft: "200px" }} >In Progress</td><br></br>

                        <td style={{ color: "#03BE35", marginLeft: "200px" }} >Completed</td><br></br>

                        <td style={{ color: "#1492E6", marginLeft: "200px" }} >To be started</td>
